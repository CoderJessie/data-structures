...
The input will come from a textare inserted into the DOM (see code below), and conversion will happen when the button is pressed.
...
HINT 3: Start without worrying about the 'tick sign'. Tackle that only after you have the variable name conversion working
...
const text = document.querySelector('texrea').value;

/*
//////////////////////////////////////////
// Working with strings - Part 3s
// Split and Join
...
); // or console.log(new Set(staff).size);
